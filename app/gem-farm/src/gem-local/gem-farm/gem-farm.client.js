...
class GemFarmClient extends gem_bank_1.GemBankClient {
    ...
    unstakeThenWithdrawAndStake(farm, farmerIdentity, bank, vault, vaultOwner, gemAmount, gemMint, receiver, shouldStake) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [gemRarity, gemRarityBump] = yield (0, gem_bank_1.findRarityPDA)(bank, gemMint);
            ...
            const widthdrawIx = yield this.bankProgram.instruction.withdrawGem(vaultAuthBump, gemBoxBump, GDRBump, gemRarityBump, gemAmount, {
                accounts: {
                    bank,
                    vault,
                    owner: (0, gem_common_1.isKp)(vaultOwner)
            ...
            const farmAcc = yield this.fetchFarmAcc(farm);
            const [farmer, farmerBump] = yield (0, gem_farm_pda_1.findFarmerPDA)(farm, identityPk);
            const [vault1, vaultBump] = yield (0, gem_bank_1.findVaultPDA)(farmAcc.bank, identityPk);
            ...
            console.log('Unstaking gems for', identityPk.toBase58());
            const unstakeIx = yield this.farmProgram.instruction.unstake(farmAuthBump, farmTreasuryBump, farmerBump, false, {
                accounts: {
                    farm,
                    farmer,
                    farmTreasury,
            ...
            const stakeIx = yield this.farmProgram.instruction.stake(farmAuthBump, farmerBump, {
                accounts: {
                    farm,
                    farmer,
                    identity: identityPk,
            ...
            yield this.conn.confirmTransaction(txSig);
    ...
    unstakeThenDepositAndStake(farm, farmerIdentity, bank, vault, vaultOwner, gemAmount, gemMint, gemSource, mintProof, metadata, creatorProof, shouldUnstake) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depositIx = yield this.bankProgram.instruction.depositGem(vaultAuthBump, gemRarityBump, gemAmount, {
                accounts: {
                    bank,
                    vault,
                    owner: (0, gem_common_1.isKp)(vaultOwner)
